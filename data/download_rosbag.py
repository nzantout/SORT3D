...
if __name__ == '__main__':
    ...
    parser.add_argument('--download_path', default='bagfiles', help="Directory to store downloaded data.")
    parser.add_argument('--platform', default='wheelchair', help="ROSbag platform.")
